...
HTTP_ACCOUNTING_MODULE_VERSION=$(curl --silent https://api.github.com/repos/Lax/ngx_http_accounting_module/git/refs/tags | jq -r '.|reverse|.[].ref' | grep -v 'rc' | head -1 | cut -d '/' -f3)
